...
const messageCn = {
  common: {
    ...
    dropdownNav: [{title: '个人中心', path: 'management'}, {title: '修改资料', path: 'changeDatum'}, {title: '福利中心', path: 'management'}],
  ...
  index: {
    showMore: '查看更多',
    aboutUsMark: ' 现在我们有多年培养萌宠经验，我们爱宠物的每一部分我们的工作！我们为您的宠物提供一个非常热情友好的环境。我们的专业团队确保您的宠物总是最高水平的护理，因为我们对所有的宠物就像自己的一家人一样。目前以专业宠物店市场为主销售渠道，正逐步开发其他渠道。近年来稳步增长的销售业绩，或许可以预示未来XX的成长趋势。',
    serveName1:'高级美容师',
    serveName2:'贵宾服务',
    serveName3:'我们爱每一个宠物',
